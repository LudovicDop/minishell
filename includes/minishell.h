...
/*   Updated: 2024/07/22 16:11:38 by ldoppler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		execute_command(t_lexer *t, int *p_fd, t_envp *envp_list, t_glob *g);
int		execute_ast(t_lexer *n, int pipe[2], t_envp **envp_list, t_glob *g);
int		ft_redirection(t_lexer *n, int *p_fd, t_glob *g, t_envp *envp_list);
void	execute_fail(t_glob *g, t_lexer *t, t_envp *envp_list, int *pipe_fd);
...
int		ft_heredoc(t_lexer *n, int *p_fd, t_glob *g, t_envp *envp_list);
...
int		ft_single_cmd(t_lexer *n, t_glob *g, int *pipe_fd, t_envp **envp_list);
