...
/*   Updated: 2024/07/21 17:24:45 by ldoppler         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					execute_command(t_lexer *token, int *pipe_fd,
						t_envp *envp_list, t_glob *glob);
int					execute_ast(t_lexer *node, int pipe[2], t_envp **envp_list,
						t_glob *glob);
int					ft_redirection(t_lexer *node, int *pipe_fd, t_glob *glob,
						t_envp *envp_list);
void				execute_fail(t_glob *glob, t_lexer *token,
						t_envp *envp_list, int *pipe_fd);
...
int					ft_heredoc(t_lexer *node, int *pipe_fd, t_glob *glob,
						t_envp *envp_list);
...
int					ft_first_node_init(t_lexer *node, t_glob *glob,
						int *pipe_fd);
int					ft_single_cmd(t_lexer *node, t_glob *glob, int *pipe_fd,
						t_envp **envp_list);
...
void				execute_fail_builtins(t_glob *glob, t_lexer *token,
						t_envp *envp_list, int *pipe_fd);
#endif
